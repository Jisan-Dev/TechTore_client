...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('signedInManually=>', result);
    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900">
        ...
        <div className="space-y-1">
          <button className="text-xs hover:underline hover:text-neutral-500 text-gray-400">Forgot password?</button>
        </div>
        ...
        <p className="px-6 text-sm text-center text-gray-400">
          ...
          <Link to="/register" className="hover:underline hover:text-neutral-500 text-gray-600">
            Sign up
          </Link>
          .
        </p>
